...
const { api, showToast, setCurrentUser, shuffleArray, getRandomItems } = NeuroAssist;
...
async function completeOnboarding() {
    try {
        ...
        await api.post('/baseline-assessment', {
            userId: user.id,
        ...
        showToast('Baseline assessment completed!', 'success');
